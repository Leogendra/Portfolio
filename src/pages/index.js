        ...
        <>
            ...
            <Root>
                <Box p={4} sx={{ backgroundColor: 'background.paper', borderRadius: 8, boxShadow: 3 }}>
                    ...
                    <Typography py={2} variant='h6'>Je suis Gatien HADDAD. bienvenue sur mon site. Vous pourrez y retrouver les projets sur lesquels j'ai travaillé ainsi que mon CV.</Typography>
