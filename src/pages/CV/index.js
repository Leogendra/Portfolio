...
import cv from '../../static/images/CV/CV.png';
import pdf from '../../static/ressources/CV/CV.pdf';
        ...
        <>
            ...
            <Breadcrumbs pt={4} pb={3} pl={3} pr={4} aria-label='breadcrumb' separator='|' sx={{ typography: 'h6' }}>
                ...
                <Link
                    underline='hover'
                    color='text.primary'
                    href='/GatienH-Portfolio/#/resume'
                    sx={{ typography: 'h6' }}>
                    CV
                </Link>
            </Breadcrumbs>
            <Box pb={2} sx={{ display: 'flex', justifyContent: 'center' }}>
                <Button variant='contained' href={pdf} download='CV_Gatien_HADDAD.pdf'>Télécharger en pdf</Button>
            </Box>
